  ...
  useEffect(() => {
    const keyboardWillShowSub = Keyboard.addListener(
      ...
      async event => {
        ...
        const newFocusedTextInputNodeHandle = NativeTextInput.State.currentlyFocusedField() ? findNodeHandle(NativeTextInput.State.currentlyFocusedField()) : NativeTextInput.State.currentlyFocusedField();
