  ...
  useEffect(() => {
    const keyboardWillShowSub = Keyboard.addListener(
      ...
      async event => {
        ...
        const newFocusedTextInputNodeHandle = NativeTextInput.State.currentlyFocusedField() ? findNodeHandle(TextInput.State.currentlyFocusedInput()) : TextInput.State.currentlyFocusedField();
